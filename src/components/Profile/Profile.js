  ...
  return (
    <div className="profile-container">
      ...
      <div className="profile-text">
        ...
        Reque sanctus lobortis ad vis. In porro graecis accusam his, sed tale indoctum omittantur id, ut saepe feugait philosophia vix. Te quidam feugiat similique nec, ius alterum partiendo similique ne. Te per ignota utamur iisque, facete gloriatur conclusionemque nam et. Et vim aliquip repudiare posidonium, an integre veritus est.
        </p>
      </div>
    </div>
  )
